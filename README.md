...
### 9.6. Запуск оценки качества на эталонных запросах
```bash
...
## 12. Решение на платформе GigaCowork (Задача 2)
...
### 12.1. Архитектура и состав сборки агента в GigaCowork
...
5. Если аббревиатура является частью названия продукта (например, DB в Arenadata DB, РЕД ВИРТ, ОС Аврора), не расшифровывай ее отдельно.
6. Строго запрещено выдумывать пароли, адреса серверов и учетные записи конкретных организаций. Если данных нет, прямо зафиксируй это.
```

### 12.3. Источники данных и ручные доработки
