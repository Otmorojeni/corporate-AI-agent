...
│   └── app.js                   # Клиентская логика вызова REST API и реактивный рендеринг
...
```
*Результат:* 10 тестов успешно проверяют `/health`, валидацию схем, ошибки 413, 415, 422, извлечение из реального PDF, обработку комплексных запросов с омонимами, офф-топик, динамическую регистрацию нового PDF в памяти, отдачу Web UI и строгое соответствие схеме OpenAPI.
